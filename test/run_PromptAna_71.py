...
#jobname='WW3000'
#jobname='WW3000_posCAL'
#jobname='WW3000_posECAL'
#jobname='WW3000_posHCAL'
#jobname='WW3000_fixTRACK'
#jobname='WW3000_fixTRACK_noHCAL'
#jobname='QCD30'
#jobname='QCD30_posCAL'
#jobname='QCD30_posECAL'
#jobname='QCD30_posHCAL'
#jobname='QCD30_fixTRACK'
#jobname='QCD30_fixTRACK_noHCAL'
#jobname='QCD170'
#jobname='QCD170_posCAL'
#jobname='QCD170_posECAL'
#jobname='QCD170_posHCAL'
#jobname='QCD170_fixTRACK'
#jobname='QCD170_fixTRACK_noHCAL'
#jobname='QCD1000'
#jobname='QCD1000_posCAL'
...
trigger_set = (os.environ.get('TRIGGER_SET','privateReRECO'))
...
if allhist=="True":
  ...
  process.jetMETAnalyzer.DoPFJetAnalysis= cms.untracked.bool(True)
  #process.jetMETAnalyzer.DoIterativeCone = cms.untracked.bool(False)
  #process.jetMETAnalyzer.DoCaloMETAnalysis= cms.untracked.bool(True)
  #process.jetMETAnalyzer.DoTcMETAnalysis= cms.untracked.bool(True)
  #process.jetMETAnalyzer.DoJPTJetAnalysis= cms.untracked.bool(False)
  #process.jetMETAnalyzer.DoJPTJetCleaning= cms.untracked.bool(False)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string("/tmp/hinzmann/reco_DQM_%s.root" % jobname)
)
