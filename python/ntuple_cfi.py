#-------------------------------------------------------------------------
# Created: Wed Apr 25 17:42:36 2012 by /data1/sezen/CMSSW_5_2_5/src/Ntuples/substructure/python/ntuple_cfi.py
...
cms.EDAnalyzer("TheNtupleMaker",
    ...
    #'float tau3()',
               ...
               cms.untracked.
               vstring(
    'patJetHelper                    selectedPatJetsCA8CHSwithNsub              200',
    #---------------------------------------------------------------------
    'double  energy()',
    'double  correctedJet("Uncorrected").energy() uncor_energy',
    'double  et()',
    ...
    'float  genChargedHadronEnergyFraction()',
    'float  genNeutralHadronEnergyFraction()',
    'float  genChargedEmEnergyFraction()',
    'float  genNeutralEmEnergyFraction()',
    'int  genChargedMultiplicity()',
    'int  nConstituents()',
    'int  partonFlavour()',
    #-- n-subjettiness variables ------------------------------------------
    #'float  userFloat("qjetsvolatility") qjetsvolatility',
