...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/opt2/rootfiles/run_reco_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_RECO_'+sample+'_711_jetCoreTrack_splitMergedNeutrals.root'),#_posHCAL_fixTRACK_splitPFecal
